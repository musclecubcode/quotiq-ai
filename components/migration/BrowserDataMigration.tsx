...
import { getAllInvoices } from "@/lib/invoice-repository";
...
type Counts = { clients: number; workOrders: number; measurements: number; notes: number; attachments: number; invoices: number };
...
function browserPayload() {
  return { version: 1, companyProfile: getCompanyProfileSnapshot() ?? undefined, clients: getAllClients(), workOrders: getAllWorkOrders(), invoices: getAllInvoices(), ...getJobIntelligenceExport() };
}
