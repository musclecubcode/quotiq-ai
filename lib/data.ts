...
export const clients: Client[] = [
  ...
  },
  {
    ...
    phone: "(512) 555-0116",
    address: "1517 Vargas Rd, Austin, TX",
    status: "lead",
  ...
  },
  {
    ...
    phone: "(512) 555-0184",
    address: "3312 Duval St, Austin, TX",
    status: "inactive",
  ...
  },
  {
    ...
    phone: "(512) 555-0127",
    address: "1900 Rio Grande St, Austin, TX",
    status: "lead",
...
/**
 * Bundles a client with everything reachable through their work orders —
 * the shape the client detail page renders. Quotes, invoices, photos,
 * notes, warranties, and documents are all joined via workOrderId rather
 * than stored redundantly against the client.
 */
